...
export class ProfileModel {
  ...
  constructor(
    ...
    this.kaplanAdminId =
      kaplanAdminId === null || kaplanAdminId === undefined
        ? null
        : kaplanAdminId;
    if (kaplanAdminId) {
      ...
      this.photoUrl =
        photoUrl == null
          ? this.kaplanAdminTypeName.toUpperCase() === 'ACCOUNTMANAGER'
            ? links.profile.accountmanager.defaultimage
            : links.profile.nurseconsultant.defaultimage
          : photoUrl;
      this.telephone = telephone;
      this.header =
        this.kaplanAdminTypeName.toUpperCase() === 'ACCOUNTMANAGER'
          ? 'Your Customer Engagement Team'
          : 'Your Kaplan Nurse Consultant';
