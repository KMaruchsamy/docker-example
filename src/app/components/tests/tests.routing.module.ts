...
const testsRoutes: Routes = [
    ...
    { path: 'tests/view/:id', component: ViewTestComponent, canDeactivate: [SharedDeactivateGuard] },
    ...
    { path: 'tests/:action/view/:id', component: ViewTestComponent, canDeactivate: [SharedDeactivateGuard] },
