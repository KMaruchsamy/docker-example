...
var Angulartics2On = (function () {
    function Angulartics2On(elRef, angulartics2) {
        this.elRef = elRef;
    ...
    Angulartics2On.prototype.ngAfterContentInit = function () {
        var _this = this;
        dom_adapter_1.DOM.on(this.el, this.angulartics2On, function (event) { return _this.eventTrack(event); });
    };
    ...
    Angulartics2On.prototype.isCommand = function () {
        return ['a:', 'button:', 'button:button', 'button:submit', 'input:button', 'input:submit'].indexOf(dom_adapter_1.DOM.tagName(this.el).toLowerCase() + ':' + (dom_adapter_1.DOM.type(this.el) || '')) >= 0;
    };
    Angulartics2On.prototype.inferEventName = function () {
        if (this.isCommand())
            return dom_adapter_1.DOM.getText(this.el) || dom_adapter_1.DOM.getValue(this.el);
        return dom_adapter_1.DOM.getProperty(this.el, 'id') || dom_adapter_1.DOM.getProperty(this.el, 'name') || dom_adapter_1.DOM.tagName(this.el);
    };
    __decorate([
    ...
    Angulartics2On = __decorate([
        ...
        __metadata('design:paramtypes', [core_1.ElementRef, angulartics2_1.Angulartics2])
    ], Angulartics2On);
