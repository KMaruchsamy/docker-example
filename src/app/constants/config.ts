export const links = {
  api: {
    ...
    admin: {
      ...
      test: {
        subjects:
          'scheduling/institutions/§institutionid/subjects?testType=§testtype',
        tests:
          'scheduling/institutions/§institutionid/tests?subject=§subject&testType=§testtype&searchString=§searchString', //Added Searchstring parameter.
        openintegratedtests: 'scheduling/OpenIntegratedTests',
        cohorts:
          'scheduling/institutions/§institutionid/activeCohorts?windowStart=§windowstart&windowEnd=§windowend&testType=§testtype',
        ...
        searchStudents:
          'scheduling/institutions/§institutionid/students?searchString=§searchstring&testId=§testid&windowStart=§windowstart&windowEnd=§windowend',
        modifyInProgressSearchStudents:
          'scheduling/modifyInProgress/studentsInInstitution?searchString=§searchString&testingSessionId=§testingSessionId',
        modifyInProgressCohortStudent:
          'scheduling/modifyInProgress/cohorts/§cohortId/students?testingSessionId=§testingSessionId',
        refreshStudentsWhoStarted:
          'scheduling/testingSessions/§testingSessionId/students?filter=§filter',
        updateModifyInProgressStudents:
          'scheduling/modifyInProgress/testingSessions/§testSessionId',
        updateScheduleDatesModifyInProgress:
          'scheduling/modifyInProgress/testingSessions/§scheduleId/windowDates',
        updateIsExamityEnabled:
          'scheduling/testingSessions/§scheduleId/examityEnable',
        updateIsProctorTrackEnabled:
          'scheduling/testingSessions/§scheduleId/proctorTrackEnable',
        selectScheduleTest: 'scheduling/tests/§testid/canTestBeTakenInAtom'
      },
      logging: {
      ...
      rosters: {
        ...
        search:
          'admin/rosters/institutions/§institutionId/students?searchString=§searchString',
        saveUserPreference: 'preferenceService/setPreference',
        getUserPreference:
          'preferenceService/users/§userId/preferences/§preferenceTypeName?userType=§userType',
        moveToCohortStudents:
          'admin/rosters/institution/§institutionId/cohort/§cohortId/students?searchString=§searchString',
        addEmailValidation:
          'admin/rosters/institution/§institutionId/student?searchEmailId=§searchEmailId',
  ...
  nursingit: {
    ...
    atomLaunchPage: 'Admin/LaunchAtom.aspx?',
    redirectToApollo: 'redirectToApollo=true',
    redirectToQuizBuilder: 'redirectTo=quizBuilder',
    redirectToQuizLibrary: 'redirectTo=quizLibrary',
...
export const roster = {
  classRosterForm:
    'https://nursing-assets-web-ktp.s3.amazonaws.com/admin/userguide/kaplan-new-class-roster-sheet.xlsx',
  formstack:
    'https://kaptest.formstack.com/forms/kaplan_nursing_new_roster_submission_form'
};
...
export enum ProgramOfStudy {
  PN = 'PN',
  RN = 'RN'
}

export enum RedirectAction {
  ApolloStudentReportCard = 'ApolloStudentReportCard',
  AtomReportCard = 'AtomReportCard',
  AtomQuizBuilder = 'AtomQuizBuilder',
  AtomQuizLibrary = 'AtomQuizLibrary'
}
